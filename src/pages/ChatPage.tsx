  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      ...
      <div className="shrink-0 border-t border-zinc-200 dark:border-zinc-800 px-4 py-3">
        ...
        <p className="text-center text-[11px] font-bold text-zinc-500 dark:text-zinc-400 mt-2">
          This is AI-based data fetched from the HR database and member profiles — for your guidance and
          help in shortlisting HR only. Aamil Saheb has full rights to select anybody.
        </p>
      </div>
    </div>
  );
